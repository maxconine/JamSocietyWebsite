...
const PROCESSING_OPTIONS = {
    ...
    format: 'webp' // Output format for better compression
};
/**
...
async function main() {
    try {
        ...
        for (const file of imageFiles) {
            ...
            const outputPath = path.join(PROCESSED_DIR, `${path.parse(file).name}_P.webp` // Add '_P' suffix to processed files
            );
